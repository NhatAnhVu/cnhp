...
const items = [
    ...
    getItem('Dịch vụ', 'sub2', <AppstoreOutlined />, [getItem('Lắp đặt/Sửa chữa máy nước', '/dv-lap-dat-may-nuoc'), getItem('Sang tên hợp đồng DVCN', '/sang-ten-hop-dong-dvcn'), getItem('Cấp lại hợp đồng DVCN', '/cap-lai-hop-dong-dvcn'), getItem('Thanh toán trực tuyến', '/thanh-toan-truc-tuyen'), getItem('Sửa chữa (ĐH, mạng lưới cấp nước sau đồng hồ)', '/dv-sua-chua'), getItem('Đăng ký thay đổi thông tin', '/dv-thong-tin-khach-hang'), getItem('Tra cứu sử dụng nước', '/dv-tra-cuu')]),
